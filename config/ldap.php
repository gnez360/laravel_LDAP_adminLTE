            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '10.1.1.201')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=sdp,dc=local'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'administrador@sdp.local'),
                'password' => env('LDAP_PASSWORD', 'sdp@cad2016'),
